...
function addMessage(text, sender) {
    ...
    if (sender === 'bot') {
        // Bot avatar with logo - inline styles to guarantee display
        ...
        avatarImg.style.cssText = 'width:100%;height:100%;object-fit:contain;border-radius:50%;display:block;background:#1a1400;';
        avatarDiv.style.cssText = 'width:42px;height:42px;border-radius:50%;border:2px solid #ffd700;box-shadow:0 0 10px rgba(255,215,0,0.35);margin-right:10px;background:#1a1400;padding:2px;overflow:hidden;display:flex;align-items:center;justify-content:center;flex-shrink:0;';
